...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" id="offload-flex">
            <a href="#">
                <img class="competition-logo" src="/img/brasileirao.svg" alt="logo_campeonatobrasileiro">
            </a>
            ...
            <div class="competition-box">
                <table class="competitions brasileiro">
                    <thead>
                        <tr>
                            <th colspan=11><h3>Standings</h3></th>
                        </tr>
                    </thead>
                    <tbody>
                        <!--Table-->
                        ...
                        <?php
                            $year = date('Y');
                            $sql = "SELECT * FROM jogos WHERE competicao = 'Campeonato Brasileiro'
                            AND horario >= '$year-01-01 00:00:00'
                            AND horario <= '$year-12-31 23:59:59'
                            ...
                            $libertadoresClube = null;
                            $libertadoresFinished = false;
                            $libertadoresCount = 0;

                            $copaDoBrasilClube = null;
                            $copaDoBrasilFinished = false;
                            $copaDoBrasilCount = 0;

                            $sudamericanaClube = null;
                        ...
                        <tr
                            <?php
                                if ($starter < $now) {
                                    ...
                                    switch ($position) {
                                        case 1:
                                            echo 'class="brasileiro1"';
                                        case 17:
                                        case 18:
                                        case 19:
                                        case 20:
                                            echo 'class="brasileiroreleg"';
                                    }
                ...
                <table class="competitions" colspan="11">
                    ...
                    <?php
                        ...
                        $sql = "SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                            ...
                            WHERE competicao = 'Campeonato Brasileiro'
                            AND horario >= '$year-01-01 00:00:00'
                            AND horario <= '$year-12-31 23:59:59'
                        ...
                        #get last round
                        $sql = "SELECT * FROM jogos WHERE competicao = 'Campeonato Brasileiro' AND horario > '$year-01-01 00:00' ORDER BY id;";    // Select table here 
                        $result = mysqli_query($conn,$sql);  // here i am run the query
                        ...
                        $sql = "SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                            ...
                            AND horario >= '$year-01-01 00:00:00'
                            AND horario <= '$year-12-31 23:59:59'
                            ORDER BY rodada, horario;";    // Select table here 
                        $result = mysqli_query($conn,$sql);  // here i am run the query
