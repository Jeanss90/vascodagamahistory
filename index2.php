...
<head>
    ...
    <meta name="theme-color" content="var(--light)"/>
...
<body class="container">
    ...
    <div class="banner">
        <div class="hero">
            <h1>Welcome to <p class="logo" style="justify-content: center; margin: 15px; cursor: revert;"><img src="/img/android-chrome-192x192.png" alt="vascodagamahistory"></p><span>vascodagamahistory.com</span></h1>
        </div>
    ...
    <main>
        <div class="index-container">
            <div>
                <h1>CR Vasco da Gama <br>(Brazilian Football Club)</h1>
            ...
            <article>
                ...
                <figure class="center">
                    <img src="/img/crest.jpg" height="300vh" alt="Vasco da Gama Crest">
                    <figcaption>Vasco da Gama Crest</figcaption>
                </figure>
                ...
                <figure class="center">
                    <img src="/img/crosses.svg" alt="Crosses" height="300vh">
                    <figcaption>Crosses</figcaption>
                </figure>    
                ...
                <figure class="center">
                    <img src="/img/shirt1.jpg" alt="Shirt 1" height="300vh">
                    <figcaption>Home shirt - season 2020/21</figcaption>
                    <img src="/img/shirt2.jpg" alt="Shirt 2" height="300vh">
                    <figcaption>Away shirt - season 2020/21</figcaption>
                </figure>
            ...
            <article> 
                ...
                <figure class="center">
                    <img src="/img/Carta_Resposta_Historica.png" width="50%" alt="The Historic Response letter">
                    <figcaption>The Historic Response letter</figcaption>
                </figure>
                ...
                <figure class="center">
                    <img src="/img/Estadio-Sao-Januario-old.jpg" height="300vh"alt="Sao Januario Construction">
                    <figcaption>Sao Januario Construction</figcaption>
                    <img src="/img/sao_januario-today.jpg" height="300vh"alt="Sao Januario nowadays">
                    <figcaption>Sao Januario nowadays</figcaption>
                </figure>
            ...
            <article> 
                ...
                <div class="center">
                    <video src="/video/1950 WORLD CUP FINAL MATCH Uruguay 2-1 Brazil.mp4" width="1024" height="576" controls poster="/img/videobanner1280x720.png">Video not supported</video>
                </div>
            ...
            <article>
                ...
                <div class="center">
                    <video src="/video/Gol de Roberto Dinamite - Vasco 2 x 1 Botafogo - 1976.mp4" width="576" height="432" controls poster="/img/videobanner960x720.png">Video not supported</video><br>
                    <video src="/video/Sorato_1989.mp4" width="576" height="432" controls poster="/img/videobanner960x720.png">Video not supported</video><br>
                    <video src="/video/Edmundo_dancinha.mp4" width="576" height="432" controls poster="/img/videobanner960x720.png">Video not supported</video><br>
                    <video src="/video/Brasileirao_2000.mp4" width="576" height="432" controls poster="/img/videobanner960x720.png">Video not supported</video><br>
                </div>
                <?php include('top.html')?>
            </article>
            ...
            <article> 
                ...
                <div class="center">
                    ...
                    <ol><b><i>Knockout Stage:</i></b><br>
                        ...
                        <li>Semifinal: River Plate 1 x 1 Vasco da Gama</li>
                ...
                <div class="card-center">
                    <div class="card" id="section5-3-1">
                        <div class="card-top">
                            ...
                            <div class="details">
                                <img src="/img/juninho_libertadores.jpg" alt="Juninho 1998">
                            </div>
                        </div>
                        <div class="watch-it">
                            <a href="/monumental.php"><p>Watch it</p></a>
                        </div>
                    </div>
                </div>

                <figure class="center">
                    <img src="/img/time_libertadores_1998.jpg" height="300vh" alt="Libertadores 1998 Squad">
                    <figcaption>Libertadores 1998 Squad</figcaption>
                </figure>
                ...
                <div class="card-center">
                    <div class="card" id="section5-3-2">
                        <div class="card-top">
                            <div class="card-title">
                                <div class="name">
                                    <h4>Mercosul Cup 2000</h4>
                                </div>
                            </div>
                            <div class="details">
                                <img src="/img/mercosul_2000.jpg" alt="Mercosul 2000">
                            </div>
                        </div>
                        <div class="watch-it">
                            <a href="/mercosul2000.php"><p>Watch it</p></a>
                        </div>
                    </div>

                    <div class="card" id="section5-3-3">
                        <div class="card-top">
                            <div class="card-title">
                                <div class="name">
                                    <h4>Romario 1000th Goal</h4>
                                </div>
                            </div>
                            <div class="details">
                                <img src="/img/romario_1000th.jpg" alt="Romario 1000">
                            </div>
                        </div>
                        <div class="watch-it">
                            <a href="/romario1000.php"><p>Watch it</p></a>
                        </div>
                    </div>
                </div>
                <br>
            ...
            <article>
                ...
                <figure class="center">
                    <img src="/img/rebaixamento_1.jpg" height="300vh" alt="Relegation photo1">
                    <figcaption>Pedrinho, current President, relegated in 2008</figcaption>
                    <img src="/img/rebaixamento_2.jpg" height="300vh" alt="Relegation photo2">
                    <figcaption>Edmundo, Vasco da Gama's idol, relegated in 2008</figcaption>
                </figure>
                ...
                <figure class="center">
                    <img src="/img/copa_do_brasil_2011.jpg" width="80%" alt="Copa do Brasil 2011">
                    <figcaption>Copa do Brasil 2011 Squad</figcaption>
                </figure>
                ...
                <figure class="center">
                    <img src="/img/diego_souza_missed_chance.png" width="70%" alt="Diego Souza missed chance">
                    <figcaption>Diego Souza missed chance</figcaption>
                </figure>
                <?php include('top.html')?>
            </article>
            ...
            <article> 
                ...
                <figure class="center">
                    <img src="/img/socio_gigante.jpg" height="300vh" alt="Masse association">
                    <figcaption>'Socio Gigante' members reaching 100.000 members</figcaption>
                    </figure>
                ...
                <figure class="center">
                    <img src="/img/777-Vasco.jpg" height="300vh" alt="777 Partners and Jorge Salgado">
                    <figcaption>777 Partners directors and Jorge Salgado</figcaption>
                </figure>
                <?php include('top.html')?>
            </article>
