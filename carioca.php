...
<head>
    ...
    <title>Campeonato Carioca</title>
        ...
        <div class="section">
            <div class="card-panel carioca">
                ...
                <a id="logo-container" href="#" class="brand-logo" style="height: inherit;">
                    <img class="responsive" src="/img/carioca2025_horizontal.svg" alt="logo_campeonatocarioca" style="padding: 10px; width: 25%; background-color: antiquewhite">
                </a>
                        ...
                        <div style="margin-bottom: 20px">
                            <table class="highlight centered mywhite">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $year = date('Y');
                                        $sql = 'SELECT * FROM jogos WHERE competicao = "Campeonato Carioca" AND horario > "'.$year.'-01-01"';    // Select table here 
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) // Showing all the data
                                        {
                                                ...
                                                $fixtures = array("casa" => $casa,"score_casa" => $score_casa, "score_fora" => $score_fora, "fora" => $fora, "horario" => $horario, "rodada" => $rodada);
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) // Showing all the data
                                        {
                                            ...
                                            foreach ($myFixtures as $fixtures) {
                                                ...
                                                if ($clube == $casa) {
                                                    ...
                                                    if (($score_casa == NULL && $horario > $now) || $rodada > 11) {
                                                        continue;
                                                    } else {
                                                ...
                                                if ($clube == $fora) {
                                                    ...
                                                    if (($score_fora == NULL && $horario > $now) || $rodada > 11) {
                                                        continue;
                                                    } else {
                                        ...
                                        $sql = 'CALL sort_table_carioca;';    // Select table here 
                                        $result = mysqli_query($conn,$sql);  // here i am run the query
                                        $i = 1;                             // only creates sequence of the data
                                    ...
                                    <?php
                                        if ($starter < $now) {
                                            if ($position == 1) {
                                                echo ' class="carioca1" style="font-weight:bold; font-style: italic; background-color: var(--carioca-dark-blue); color: var(--mygold)"';
                                            } else if ($position == 12) {
                                                echo ' class="cariocareleg" style="font-weight:bold; font-style: italic; background-color: var(--carioca-red); color: antiquewhite"';
                                            } else if ($position  >=2 && $position <= 4) {
                                                echo ' class="carioca2" style="background-color: var(--carioca-blue); color: antiquewhite"';
                                            }
                                        }
                                    ?>
                                    >
                                ...
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        $sql = 'SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                                            ...
                                            WHERE competicao = "Campeonato Carioca" ORDER BY horario;
                                        ';    // Select table here 
                                        $result = mysqli_query($conn,$sql);  // here i am run the query
                                        ...
                                        #get last round
                                        $sql = 'SELECT * FROM jogos WHERE competicao = "Campeonato Carioca" AND horario > "2025-01-01 00:00" ORDER BY id;
                                        ';    // Select table here 
                                        $result = mysqli_query($conn,$sql);  // here i am run the query
                                        ...
                                        $sql = 'SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                                            ...
                                            INNER JOIN brasao_casa ON brasao_casa.clube = jogos.casa)
                                            INNER JOIN brasao_fora ON brasao_fora.clube = jogos.fora)
                                            WHERE competicao = "Campeonato Carioca" ORDER BY rodada, horario;
                                        ';    // Select table here 
                                        $result = mysqli_query($conn,$sql);  // here i am run the query
