<!-- Adding Fixtures for knockout fase-->
    ...
    <table class="competitions" colspan="11">
        ...
        <?php
            $sql = "SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                ...
                WHERE competicao = 'Copa Sudamericana' AND rodada >= 7 AND horario > '$year-01-01 00:00' ORDER BY horario;";    // Select table here 
            ...
            #get last round
            $sql = "SELECT * FROM jogos WHERE competicao = 'Copa Sudamericana' AND rodada >= 7 AND horario > '$year-01-01 00:00' ORDER BY id;";    // Select table here 
            $result = mysqli_query($conn,$sql);  // here i am run the query
            ...
            $sql = "SELECT jogos.id, horario, escudo_casa, casa, score_casa, penalti_casa, penalti_fora, score_fora, fora, escudo_fora, competicao, estadio, rodada
                ...
                INNER JOIN brasao_casa ON brasao_casa.clube = jogos.casa)
                INNER JOIN brasao_fora ON brasao_fora.clube = jogos.fora)
                WHERE competicao = 'Copa Sudamericana' AND rodada >= 7 ORDER BY id, horario;";    // Select table here 
            $result = mysqli_query($conn,$sql);  // here i am run the query
